...
class Session extends ChangeNotifier {
  ...
  /// Two things have to be true for anyone to see you: the server needs a
  /// recent coordinate for you, and it needs to believe you are online.
  /// Discovery filters on User.status, which only the presence WebSocket sets.
  void _goOnline() {
    final id = me?.id;
    if (id != null) Presence.instance.connect(id);
